...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'symfony', 'password' => 'symfony', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_0000000060b1fcc80000000069e8986b6afb81963d4107ad527ade4afb43af9b(
    ...
    {
        $this->services['doctrine_cache.providers.doctrine.orm.default_result_cache'] = $instance = new \Doctrine\Common\Cache\ApcCache();
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt|error)|css|images|js)/'), 'security.firewall.map.context.api' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api'), 'security.firewall.map.context.default' => NULL)), $this->get('event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_ApiService()
    {
        ...
        return $this->services['security.firewall.map.context.api'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\SimplePreAuthenticationListener($a, $b, 'api', $this->get('app.security.api_token_authenticator'), $c, $this->get('event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '57f9236375ba05.40100241', $c, $b), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'api', NULL, NULL, NULL, $c, true));
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setMetadataCache(new \Symfony\Component\Validator\Mapping\Cache\ApcCache('validator_2541dc78135ef0794fbda2ad0c8bda6c40e974587d68f7f2ac2c941759e54ac7'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'validator.mapping.cache.prefix' => 'validator_2541dc78135ef0794fbda2ad0c8bda6c40e974587d68f7f2ac2c941759e54ac7',
...
class DoctrineORMEntityManager_0000000060b1fcc80000000069e8986b6afb81963d4107ad527ade4afb43af9b extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder57f9236560643803587432 = null;
    private $initializer57f92365606b0195433692 = null;
    private static $publicProperties57f9236560326063095215 = array(
        
    );
    public function getConnection()
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'getConnection', array(), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->getConnection();
    }
    public function getMetadataFactory()
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'getMetadataFactory', array(), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->getMetadataFactory();
    }
    public function getExpressionBuilder()
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'getExpressionBuilder', array(), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->getExpressionBuilder();
    }
    public function beginTransaction()
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'beginTransaction', array(), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->beginTransaction();
    }
    public function getCache()
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'getCache', array(), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->getCache();
    }
    public function transactional($func)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'transactional', array('func' => $func), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->transactional($func);
    }
    public function commit()
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'commit', array(), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->commit();
    }
    public function rollback()
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'rollback', array(), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->rollback();
    }
    public function getClassMetadata($className)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'getClassMetadata', array('className' => $className), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->getClassMetadata($className);
    }
    public function createQuery($dql = '')
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'createQuery', array('dql' => $dql), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->createQuery($dql);
    }
    public function createNamedQuery($name)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'createNamedQuery', array('name' => $name), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->createNamedQuery($name);
    }
    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->createNativeQuery($sql, $rsm);
    }
    public function createNamedNativeQuery($name)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->createNamedNativeQuery($name);
    }
    public function createQueryBuilder()
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'createQueryBuilder', array(), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->createQueryBuilder();
    }
    public function flush($entity = null)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'flush', array('entity' => $entity), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->flush($entity);
    }
    public function find($entityName, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->find($entityName, $id, $lockMode, $lockVersion);
    }
    public function getReference($entityName, $id)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->getReference($entityName, $id);
    }
    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->getPartialReference($entityName, $identifier);
    }
    public function clear($entityName = null)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'clear', array('entityName' => $entityName), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->clear($entityName);
    }
    public function close()
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'close', array(), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->close();
    }
    public function persist($entity)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'persist', array('entity' => $entity), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->persist($entity);
    }
    public function remove($entity)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'remove', array('entity' => $entity), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->remove($entity);
    }
    public function refresh($entity)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'refresh', array('entity' => $entity), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->refresh($entity);
    }
    public function detach($entity)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'detach', array('entity' => $entity), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->detach($entity);
    }
    public function merge($entity)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'merge', array('entity' => $entity), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->merge($entity);
    }
    public function copy($entity, $deep = false)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->copy($entity, $deep);
    }
    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->lock($entity, $lockMode, $lockVersion);
    }
    public function getRepository($entityName)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'getRepository', array('entityName' => $entityName), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->getRepository($entityName);
    }
    public function contains($entity)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'contains', array('entity' => $entity), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->contains($entity);
    }
    public function getEventManager()
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'getEventManager', array(), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->getEventManager();
    }
    public function getConfiguration()
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'getConfiguration', array(), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->getConfiguration();
    }
    public function isOpen()
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'isOpen', array(), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->isOpen();
    }
    public function getUnitOfWork()
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'getUnitOfWork', array(), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->getUnitOfWork();
    }
    public function getHydrator($hydrationMode)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->getHydrator($hydrationMode);
    }
    public function newHydrator($hydrationMode)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->newHydrator($hydrationMode);
    }
    public function getProxyFactory()
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'getProxyFactory', array(), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->getProxyFactory();
    }
    public function initializeObject($obj)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'initializeObject', array('obj' => $obj), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->initializeObject($obj);
    }
    public function getFilters()
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'getFilters', array(), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->getFilters();
    }
    public function isFiltersStateClean()
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'isFiltersStateClean', array(), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->isFiltersStateClean();
    }
    public function hasFilters()
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'hasFilters', array(), $this->initializer57f92365606b0195433692);
        return $this->valueHolder57f9236560643803587432->hasFilters();
    }
    public function __construct($initializer)
    {
        $this->initializer57f92365606b0195433692 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, '__get', array('name' => $name), $this->initializer57f92365606b0195433692);
        if (isset(self::$publicProperties57f9236560326063095215[$name])) {
            return $this->valueHolder57f9236560643803587432->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder57f9236560643803587432;
    ...
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer57f92365606b0195433692);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder57f9236560643803587432;
    ...
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, '__isset', array('name' => $name), $this->initializer57f92365606b0195433692);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder57f9236560643803587432;
    ...
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, '__unset', array('name' => $name), $this->initializer57f92365606b0195433692);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder57f9236560643803587432;
    ...
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, '__clone', array(), $this->initializer57f92365606b0195433692);
        $this->valueHolder57f9236560643803587432 = clone $this->valueHolder57f9236560643803587432;
    }
    public function __sleep()
    {
        $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, '__sleep', array(), $this->initializer57f92365606b0195433692);
        return array('valueHolder57f9236560643803587432');
    }
    ...
    {
        return $this->initializer57f92365606b0195433692;
    }
    public function initializeProxy()
    {
        return $this->initializer57f92365606b0195433692 && $this->initializer57f92365606b0195433692->__invoke($this->valueHolder57f9236560643803587432, $this, 'initializeProxy', array(), $this->initializer57f92365606b0195433692);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder57f9236560643803587432;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder57f9236560643803587432;
    }
}
