...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.listener.domain.exception' => 'getApp_Listener_Domain_ExceptionService',
            'app.managers.user.user' => 'getApp_Managers_User_UserService',
            'app.repository.user.user' => 'getApp_Repository_User_UserService',
            'app.repository.user.user_session' => 'getApp_Repository_User_UserSessionService',
            'app.security.api_token_authenticator' => 'getApp_Security_ApiTokenAuthenticatorService',
            'app.security.api_user_provider' => 'getApp_Security_ApiUserProviderService',
            'app.security.user_password_encoder' => 'getApp_Security_UserPasswordEncoderService',
        ...
        $this->aliases = array(
            ...
            'security.user_checker.default' => 'security.user_checker.api',
    ...
    /**
     * Gets the 'app.listener.domain.exception' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Listener\DomainExceptionListener A AppBundle\Listener\DomainExceptionListener instance
     */
    protected function getApp_Listener_Domain_ExceptionService()
    {
        return $this->services['app.listener.domain.exception'] = new \AppBundle\Listener\DomainExceptionListener();
    }

    /**
     * Gets the 'app.managers.user.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Services\Managers\User\UserManager A AppBundle\Services\Managers\User\UserManager instance
     */
    protected function getApp_Managers_User_UserService()
    {
        return $this->services['app.managers.user.user'] = new \AppBundle\Services\Managers\User\UserManager($this->get('doctrine.orm.default_entity_manager'), $this->get('app.repository.user.user'), $this->get('app.repository.user.user_session'), $this->get('app.security.user_password_encoder'), $this->get('validator'));
    }

    /**
     * Gets the 'app.repository.user.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Repository\User\UserRepository A AppBundle\Repository\User\UserRepository instance
     */
    protected function getApp_Repository_User_UserService()
    {
        return $this->services['app.repository.user.user'] = new \AppBundle\Repository\User\UserRepository($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.repository.user.user_session' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Repository\User\UserSessionRepository A AppBundle\Repository\User\UserSessionRepository instance
     */
    protected function getApp_Repository_User_UserSessionService()
    {
        return $this->services['app.repository.user.user_session'] = new \AppBundle\Repository\User\UserSessionRepository($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'app.security.api_token_authenticator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Security\Authentication\ApiTokenAuthenticator A AppBundle\Security\Authentication\ApiTokenAuthenticator instance
     */
    protected function getApp_Security_ApiTokenAuthenticatorService()
    {
        return $this->services['app.security.api_token_authenticator'] = new \AppBundle\Security\Authentication\ApiTokenAuthenticator($this->get('app.security.api_user_provider'));
    }

    /**
     * Gets the 'app.security.api_user_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Security\User\ApiUserProvider A AppBundle\Security\User\ApiUserProvider instance
     */
    protected function getApp_Security_ApiUserProviderService()
    {
        return $this->services['app.security.api_user_provider'] = new \AppBundle\Security\User\ApiUserProvider($this->get('app.repository.user.user'), $this->get('app.repository.user.user_session'));
    }

    /**
     * Gets the 'app.security.user_password_encoder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Security\User\UserPasswordEncoder A AppBundle\Security\User\UserPasswordEncoder instance
     */
    protected function getApp_Security_UserPasswordEncoderService()
    {
        return $this->services['app.security.user_password_encoder'] = new \AppBundle\Security\User\UserPasswordEncoder($this->get('security.encoder_factory'), 'CoreDomain\\Model\\User\\User');
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.exception', array(0 => 'app.listener.domain.exception', 1 => 'onDomainException'), 0);
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_0000000073cd4dc40000000075a2d45528a0c7188fe871033e49ce7a85e414ea(
        ...
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('/vagrant/src/AppBundle/Resources/config/doctrine' => 'CoreDomain\\Model'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'CoreDomain\\Model');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('CoreDomain' => 'CoreDomain\\Model'));
    ...
    {
        return $this->services['fos_rest.converter.request_body'] = new \FOS\RestBundle\Request\RequestBodyParamConverter($this->get('fos_rest.serializer'), '', '', $this->get('validator', ContainerInterface::NULL_ON_INVALID_REFERENCE), 'validationErrors');
    }
    ...
    {
        return $this->services['jms_serializer.datetime_handler'] = new \JMS\Serializer\Handler\DateHandler('Y-m-d\\TH:i:sO', 'Europe/Minsk', true);
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('CoreDomain\\Model' => '/vagrant/src/AppBundle/Resources/config/serializer/model', 'CoreDomain\\DTO' => '/vagrant/src/AppBundle/Resources/config/serializer/dto', 'AppBundle\\Model' => '/vagrant/src/AppBundle/Resources/config/serializer/model'));
    ...
    {
        return $this->services['nelmio_cors.options_provider.config'] = new \Nelmio\CorsBundle\Options\ConfigProvider(array('^/api/' => array('allow_credentials' => true, 'allow_origin' => true, 'expose_headers' => array(0 => 'X-Total-Count'), 'allow_headers' => array(0 => 'origin', 1 => 'content-type', 2 => 'x-custom-auth', 3 => 'authorization'), 'allow_methods' => array(0 => 'POST', 1 => 'PUT', 2 => 'GET', 3 => 'DELETE', 4 => 'PATCH', 5 => 'OPTIONS'), 'max_age' => 3600)), array('allow_origin' => array(), 'allow_credentials' => false, 'allow_headers' => array(), 'expose_headers' => array(), 'allow_methods' => array(), 'max_age' => 0, 'hosts' => array(), 'origin_regex' => false));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('CoreDomain\\Model\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt|error)|css|images|js)/'), 'security.firewall.map.context.api' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api'), 'security.firewall.map.context.default' => NULL)), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_ApiService()
    {
        ...
        return $this->services['security.firewall.map.context.api'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\SimplePreAuthenticationListener($a, $b, 'api', $this->get('app.security.api_token_authenticator'), $c, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '57f9235b29c6f1.93992044', $c, $b), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'api', NULL, NULL, NULL, $c, true));
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => true, 'resource_files' => array('pt_BR' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt_BR.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt_BR.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pt_BR.xlf'), 'pl' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pl.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pl.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pl.xlf'), 'de' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.de.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.de.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.de.xlf'), 'sq' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sq.xlf'), 'vi' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.vi.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.vi.xlf'), 'hy' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hy.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hy.xlf'), 'ru' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ru.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ru.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ru.xlf', 3 => '/vagrant/src/AppBundle/Resources/translations/messages.ru.yml'), 'sv' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sv.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sv.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sv.xlf'), 'tr' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tr.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.tr.xlf'), 'hr' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hr.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hr.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.hr.xlf'), 'fi' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fi.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fi.xlf'), 'lb' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lb.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lb.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.lb.xlf'), 'bg' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bg.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.bg.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.bg.xlf'), 'th' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.th.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.th.xlf'), 'nl' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nl.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nl.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.nl.xlf'), 'ar' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ar.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ar.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ar.xlf'), 'zh_CN' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_CN.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_CN.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.zh_CN.xlf'), 'id' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.id.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.id.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.id.xlf'), 'cs' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cs.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.cs.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.cs.xlf'), 'no' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.no.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.no.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.no.xlf'), 'cy' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cy.xlf'), 'et' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.et.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.et.xlf'), 'gl' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.gl.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.gl.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.gl.xlf'), 'af' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.af.xlf'), 'it' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.it.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.it.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.it.xlf'), 'en' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.en.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.en.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.en.xlf'), 'da' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.da.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.da.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.da.xlf'), 'hu' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hu.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hu.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.hu.xlf'), 'sk' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sk.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sk.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sk.xlf'), 'lv' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lv.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lv.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.lv.xlf'), 'ro' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ro.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ro.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ro.xlf'), 'zh_TW' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_TW.xlf'), 'sl' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sl.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sl.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sl.xlf'), 'fr' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fr.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fr.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.fr.xlf'), 'el' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.el.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.el.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.el.xlf'), 'uk' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.uk.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.uk.xlf'), 'sr_Cyrl' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Cyrl.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Cyrl.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sr_Cyrl.xlf'), 'mn' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.mn.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.mn.xlf'), 'es' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.es.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.es.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.es.xlf'), 'ca' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ca.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ca.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ca.xlf'), 'pt' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt.xlf'), 'lt' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lt.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lt.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.lt.xlf'), 'sr_Latn' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Latn.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Latn.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sr_Latn.xlf'), 'fa' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fa.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fa.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.fa.xlf'), 'ja' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ja.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ja.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ja.xlf'), 'nn' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nn.xlf'), 'az' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.az.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.az.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.az.xlf'), 'eu' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.eu.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.eu.xlf'), 'he' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.he.xlf', 1 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.he.xlf', 2 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.he.xlf'), 'ua' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ua.xlf'), 'pt_PT' => array(0 => '/vagrant/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pt_PT.xlf'))), array());
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('BM3L9938BRkLvGEE2UKNvtjSZ1');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => '/vagrant/src/AppBundle/Resources/config/validation/dto/User.ProfileDTO.yml', 1 => '/vagrant/src/AppBundle/Resources/config/validation/dto/User.UserRegisterDTO.yml', 2 => '/vagrant/src/AppBundle/Resources/config/validation/model/User.User.yml'));
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('/api/(sessions|users)', NULL, array(0 => 'POST')), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('/api/sessions$', NULL, array(0 => 'DELETE')), array(0 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/users'), array(0 => 'ROLE_USER'), NULL);
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\SimpleAuthenticationProvider($this->get('app.security.api_token_authenticator'), $this->get('app.security.api_user_provider'), 'api'), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57f9235b29c6f1.93992044'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57f9235b29c6f1.93992044')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'BM3L9938BRkLvGEE2UKNvtjSZ1',
            'locale' => 'ru',
            ...
            'kernel.secret' => 'BM3L9938BRkLvGEE2UKNvtjSZ1',
...
class DoctrineORMEntityManager_0000000073cd4dc40000000075a2d45528a0c7188fe871033e49ce7a85e414ea extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder57f9235da2e64915449303 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer57f9235da2ea2995983278 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties57f9235da2de5205308873 = array(
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'getConnection', array(), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->getConnection();
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'getMetadataFactory', array(), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->getMetadataFactory();
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'getExpressionBuilder', array(), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->getExpressionBuilder();
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'beginTransaction', array(), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->beginTransaction();
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'getCache', array(), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->getCache();
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'transactional', array('func' => $func), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->transactional($func);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'commit', array(), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->commit();
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'rollback', array(), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->rollback();
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'getClassMetadata', array('className' => $className), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->getClassMetadata($className);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'createQuery', array('dql' => $dql), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->createQuery($dql);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'createNamedQuery', array('name' => $name), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->createNamedQuery($name);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->createNativeQuery($sql, $rsm);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->createNamedNativeQuery($name);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'createQueryBuilder', array(), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->createQueryBuilder();
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'flush', array('entity' => $entity), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->flush($entity);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->find($entityName, $id, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->getReference($entityName, $id);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->getPartialReference($entityName, $identifier);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'clear', array('entityName' => $entityName), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->clear($entityName);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'close', array(), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->close();
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'persist', array('entity' => $entity), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->persist($entity);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'remove', array('entity' => $entity), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->remove($entity);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'refresh', array('entity' => $entity), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->refresh($entity);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'detach', array('entity' => $entity), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->detach($entity);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'merge', array('entity' => $entity), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->merge($entity);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->copy($entity, $deep);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->lock($entity, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'getRepository', array('entityName' => $entityName), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->getRepository($entityName);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'contains', array('entity' => $entity), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->contains($entity);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'getEventManager', array(), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->getEventManager();
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'getConfiguration', array(), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->getConfiguration();
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'isOpen', array(), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->isOpen();
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'getUnitOfWork', array(), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->getUnitOfWork();
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->getHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->newHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'getProxyFactory', array(), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->getProxyFactory();
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'initializeObject', array('obj' => $obj), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->initializeObject($obj);
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'getFilters', array(), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->getFilters();
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'isFiltersStateClean', array(), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->isFiltersStateClean();
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'hasFilters', array(), $this->initializer57f9235da2ea2995983278);

        return $this->valueHolder57f9235da2e64915449303->hasFilters();
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 = $initializer;
    }
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, '__get', array('name' => $name), $this->initializer57f9235da2ea2995983278);

        if (isset(self::$publicProperties57f9235da2de5205308873[$name])) {
            return $this->valueHolder57f9235da2e64915449303->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder57f9235da2e64915449303;
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer57f9235da2ea2995983278);
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, '__isset', array('name' => $name), $this->initializer57f9235da2ea2995983278);
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, '__unset', array('name' => $name), $this->initializer57f9235da2ea2995983278);
    ...
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, '__clone', array(), $this->initializer57f9235da2ea2995983278);

        $this->valueHolder57f9235da2e64915449303 = clone $this->valueHolder57f9235da2e64915449303;
    }

    public function __sleep()
    {
        $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, '__sleep', array(), $this->initializer57f9235da2ea2995983278);

        return array('valueHolder57f9235da2e64915449303');
    }
    ...
    {
        return $this->initializer57f9235da2ea2995983278;
    }
    ...
    {
        return $this->initializer57f9235da2ea2995983278 && $this->initializer57f9235da2ea2995983278->__invoke($this->valueHolder57f9235da2e64915449303, $this, 'initializeProxy', array(), $this->initializer57f9235da2ea2995983278);
    }
    ...
    {
        return null !== $this->valueHolder57f9235da2e64915449303;
    }
    ...
    {
        return $this->valueHolder57f9235da2e64915449303;
    }
